...
var DayComponent = React.createClass({displayName: 'DayComponent',
        ...
        switch (this.props.data.currentMode) {
            ...
            case 'manual':
                ...
                if (this.props.data.slots.length) {
                    ...
                    return (
                        React.DOM.div( {className:"copyModeContainer no-slots", onClick:this.addTimeSlot}, 
                            React.DOM.p( {className:"schedule-text-middle"}, "Create slots here")
                        )
                        );
                }
                break;
    ...
    getSwitchToCopyModeAction: function() {
        ...
        if (canSwitchToCopyMode) {
            return (
                React.DOM.a( {className:"schedule-text-middle schedule-icon-gap", title:"Make it same as one of other days",
    ...
    getDeleteAction: function() {
        ...
        return (
            React.DOM.a( {className:"schedule-text-middle", title:"Remove All Slots",
    ...
    getControls: function() {
        return (
            React.DOM.div( {className:"text-right"}, 
                React.DOM.a( {className:"schedule-text-middle schedule-icon-gap", title:this.getRowActionItemIconTitle(),
